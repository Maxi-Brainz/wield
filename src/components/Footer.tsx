        ...
        <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12" staggerDelay={0.12}>
          ...
          <StaggerItem className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <a href="https://facebook.com/WIELDInitiative22" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-gold-soft/20 transition-colors" aria-label="Follow us on Facebook">
